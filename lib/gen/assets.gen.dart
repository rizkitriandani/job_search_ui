...
class $AssetsImagesGen {
  ...
  /// File path: assets/images/img_company_1.png
  AssetGenImage get imgCompany1 =>
      const AssetGenImage('assets/images/img_company_1.png');

  /// File path: assets/images/img_company_2.png
  AssetGenImage get imgCompany2 =>
      const AssetGenImage('assets/images/img_company_2.png');

  /// File path: assets/images/img_company_3.png
  AssetGenImage get imgCompany3 =>
      const AssetGenImage('assets/images/img_company_3.png');

  /// File path: assets/images/img_company_4.png
  AssetGenImage get imgCompany4 =>
      const AssetGenImage('assets/images/img_company_4.png');

  /// File path: assets/images/img_get_started.png
  AssetGenImage get imgGetStarted =>
      const AssetGenImage('assets/images/img_get_started.png');
}
